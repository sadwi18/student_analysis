...
# --------------------------------------------
# Third Chart: Average G3 by Study Time
# --------------------------------------------

# Calculate average G3 for each study time level
avg_g3_studytime = (
...
# Create a bar chart showing average G3 by study time
fig_studytime = px.bar(
    avg_g3_studytime,
    x="studytime",
    y="Average G3",
